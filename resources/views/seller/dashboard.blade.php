          ...
          <div class="card-body">
              <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                  ...
                  <div class="d-flex align-items-center">
                      ...
                      <div class="fs-1 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{$data['brands_cnt']}}" >0</div>
                  </div>
                  <!--end::Number-->
              
                  <!--begin::Label-->
                  <div class="fw-bold fs-3 ">Total Brands </div>
                  <!--end::Label-->
              </div>
          </div>
      <!--end::Card body-->
             ...
             <div class="card-body">
                 <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                     ...
                     <div class="d-flex align-items-center">
                         ...
                         <div class="fs-1 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{$data['products_cnt']}}" >0</div>
                     </div>
                     <!--end::Number-->
