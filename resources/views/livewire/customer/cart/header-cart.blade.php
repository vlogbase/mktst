<div>
    <li class="dropdown cart_dropdown"><a class="nav-link cart_trigger {{request()->routeIs('cart') || request()->routeIs('checkout') ? 'active' : ''}}" href="#" data-bs-toggle="dropdown"><i class="linearicons-cart"></i><span class="cart_count">{{count($cartItems)}}</span></a>
