<div>
    ...
    <div class="product">
        ...
        <div class="product_info">
            ...
            <span class="text-secondary">In Pack: {{ $product->productdetail->pack }}</span><br>
            ...
            <div class="btn-group mt-2 " role="group">
                @if ($product->calcStock() > 0)
                    <button wire:click="addToCart" class="btn btn-sm btn-dark rounded-0 "><i
                ...
                @else
                    <a class="btn btn-sm btn-light  rounded-0  align-left" href="{{ route('contact_us') }}">Contact
                        Us</a>
                @endif
                <a class="btn btn-sm add_wishlist" wire:click="addToFav"><i
                        class="{{ $userFavorited == 0 ? 'far' : 'fas' }} fa-heart text-danger"></i></a>
