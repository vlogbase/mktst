    ...
    <form id="kt_account_profile_details_form" class="form" wire:submit.prevent="submit">
        ...
        <div class="card-body border-top p-9">
          ...
          <div class="row mb-6">
            ...
            <div class="col-lg-8 fv-row">
                ...
                <input type="text"  wire:model="sku" class="form-control form-control-lg form-control-solid @error('sku') is-invalid @enderror" />
            </div>
        ...
        <!--begin::Input group-->
         <div class="row mb-6">
            ...
            <!--begin::Col-->
            <div class="col-lg-8 fv-row">
                <input type="number" step="0.01" wire:model="stock" class="form-control form-control-lg form-control-solid @error('stock') is-invalid @enderror" />
        ...
        <div class="row mb-6">
            ...
            <!--begin::Col-->
            <div class="col-lg-8 fv-row">
                <input type="number" step="0.01" wire:model="reorder" class="form-control form-control-lg form-control-solid @error('reorder') is-invalid @enderror" />
                @error('reorder') <span class="text-danger">{{ $message }}</span> @enderror
            </div>
            <!--end::Col-->
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-6">
            ...
            <!--begin::Col-->
            <div class="col-lg-8 fv-row">
                <input type="number" step="0.01" wire:model="taxrate" class="form-control form-control-lg form-control-solid @error('taxrate') is-invalid @enderror" />
                @error('taxrate') <span class="text-danger">{{ $message }}</span> @enderror
            </div>
            <!--end::Col-->
        </div>
        <!--end::Input group-->
         ...
         <div class="row mb-6">
            ...
            <!--begin::Col-->
            <div class="col-lg-8 fv-row">
                <input type="number" step="0.01" wire:model="per_unit" class="form-control form-control-lg form-control-solid @error('per_unit') is-invalid @enderror" />
                @error('per_unit') <span class="text-danger">{{ $message }}</span> @enderror
            </div>
            <!--end::Col-->
        </div>
        <!--end::Input group-->
