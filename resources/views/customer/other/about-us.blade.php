        ...
        <div class="container">
            <div class="row align-items-center  mb-5">
                <div class="col-lg-6 order-1 order-lg-1">
                    <div class="about_img scene mb-4 mb-lg-0">
                        <img src="customer_assets/images/cold-storage-warehouse-with-stacks-crates-containing-fresh-produce-generative-ai.jpg" alt="about_img"/>
                    </div>
                </div>
                <div class="col-lg-6 order-2 order-lg-2">
                    <p>Markket was established in 1985, it has grown over the years from a small corner outlet, to a well-established state of the art multi temperature and multi cultural foodservice distributor.</p>
            ...
            <div class="row align-items-center mt-5 mb-5">
                ...
                <div class="col-lg-6 order-1 order-lg-2">
                    <div class="about_img scene mb-4 mb-lg-0">
                        <img src="customer_assets/images/stack-multi-colored-pencils-store.jpg" alt="about_img"/>
                    </div>
                </div>
            </div>
            <div class="row align-items-center mt-5 mb-5">
                <div class="col-lg-6 order-1 order-lg-1">
                    <div class="about_img scene mb-4 mb-lg-0">
                        <img src="customer_assets/images/man-looking-away-while-standing-supermarket.jpg" alt="about_img"/>
                    </div>
                </div>
                <div class="col-lg-6 order-2 order-lg-2">
            ...
            <div class="row align-items-center mt-5 mb-5">
                ...
                <div class="col-lg-6 order-1 order-lg-2">
                    <div class="about_img scene mb-4 mb-lg-0">
                        <img src="customer_assets/images/warehouse-aisle-ikea-store.jpg" alt="about_img"/>
                    </div>
                </div>
            </div>
        </div>
