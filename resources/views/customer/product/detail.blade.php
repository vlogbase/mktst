            ...
            <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
              <div class="product-image">
                    <div class="product_img_box">
                        <img id="product_img" src='{{$product->getCoverImage()}}' data-zoom-image="{{$product->getCoverImage()}}" alt="product_img1" />
                    ...
                    <div id="pr_item_gallery" class="product_gallery_item slick_slider" data-slides-to-show="4" data-slides-to-scroll="1" data-infinite="false">
                        @foreach($product->productimages as $image)
                            <div class="item">
                                <a href="#" class="product_gallery_item {{$loop->index == 0 ? 'active' : ''}}" data-image="{{$image->path}}" data-zoom-image="{{$image->path}}">
                ...
                <div class="pr_detail">
                            ...
                            <ul class="product-meta">
                                ...
                                <li>Status: 
                                    @if($product->calcStock() > 10) 
                                        ...
                                        <span class="  font-weight-bold text-info mb-2">Last {{ $product->calcStock() }} Item</span>
                                        @else
                                ...
                                <li>Categories: 
                                    ...
                                    <a href="{{route('category_products',$category->slug)}}">{{$category->name}}</a>
                                    @endforeach
                                </li>
                    ...
                    <div class="product_share">
                        @if($product->calcStock() <= 0)
                            <span class="text-danger">This product is currently not available. But if you contact us, we will try to supply it for you.</span>
                        @endif
                    </div>
                </div>
            </div>
