<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
    ...
    <div class="menu-item">
        <a class="menu-link {{ request()->routeIs('admin.brands.*') ? 'active' : '' }}"
            href="{{ route('admin.brands.list') }}">
            <span class="menu-icon">
                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                <span class="svg-icon svg-icon-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
    ...
    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
        ...
        <div class="menu-sub menu-sub-accordion menu-active-bg">
            <div class="menu-item ">
                <a class="menu-link {{ request()->routeIs('admin.campaigns.coupons.*') ? 'active' : '' }}"
                    href="{{ route('admin.campaigns.coupons.list') }}">
    ...
    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
        ...
        <div class="menu-sub menu-sub-accordion menu-active-bg">
            <div class="menu-item">
                <a class="menu-link {{ request()->routeIs('admin.contents.sliders.web') ? 'active' : '' }}"
                    href="{{ route('admin.contents.sliders.web') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ request()->routeIs('admin.contents.sliders.app') ? 'active' : '' }}"
                    href="{{ route('admin.contents.sliders.app') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ request()->routeIs('admin.contents.sliders.ticker') ? 'active' : '' }}"
                    href="{{ route('admin.contents.sliders.ticker') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
    ...
    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
        <span
            class="menu-link  {{ request()->routeIs('admin.contents.blogs.*') || request()->routeIs('admin.contents.news.*') || request()->routeIs('admin.contents.gallery.*') ? 'active' : '' }}">
            <span class="menu-icon">
                <!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm007.svg-->
                <span class="svg-icon svg-icon-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
        ...
        <div class="menu-sub menu-sub-accordion menu-active-bg ">
            <div class="menu-item">
                <a class="menu-link {{ request()->routeIs('admin.contents.blogs.*') ? 'active' : '' }}"
                    href="{{ route('admin.contents.blogs.list') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ request()->routeIs('admin.contents.news.*') ? 'active' : '' }}"
                    href="{{ route('admin.contents.news.list') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ request()->routeIs('admin.contents.gallery.list') ? 'active' : '' }}"
                    href="{{ route('admin.contents.gallery.list') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
    ...
    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
        ...
        <div class="menu-sub menu-sub-accordion menu-active-bg">
            <div class="menu-item">
                <a class="menu-link {{ request()->routeIs('admin.contents.other.messages.*') ? 'active' : '' }}"
                    href="{{ route('admin.contents.other.messages.list') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ request()->routeIs('admin.contents.other.jobresumes.*') ? 'active' : '' }}"
                    href="{{ route('admin.contents.other.jobresumes.list') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ request()->routeIs('admin.contents.other.newsletter.list') ? 'active' : '' }}"
                    href="{{ route('admin.contents.other.newsletter.list') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ request()->routeIs('admin.contents.other.popup.list') ? 'active' : '' }}"
                    href="{{ route('admin.contents.other.popup.list') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ request()->routeIs('admin.contents.other.advertisement.list') ? 'active' : '' }}"
                    href="{{ route('admin.contents.other.advertisement.list') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ request()->routeIs('admin.contents.other.rss.list') ? 'active' : '' }}"
                    href="{{ route('admin.contents.other.rss.list') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
            ...
            <div class="menu-item">
                <a class="menu-link {{ request()->routeIs('admin.contents.other.tickets.list') ? 'active' : '' }}"
                    href="{{ route('admin.contents.other.tickets.list') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
    ...
    <div class="menu-item">
        <a class="menu-link {{ request()->routeIs('admin.settings.shipping') ? 'active' : '' }}"
    ...
    <div class="menu-item">
        <a class="menu-link {{ request()->routeIs('admin.settings.order_rules') ? 'active' : '' }}"
            href="{{ route('admin.settings.order_rules') }}">
            <span class="menu-icon">
                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                <span class="svg-icon svg-icon-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
    ...
    <div class="menu-item">
        <a class="menu-link {{ request()->routeIs('admin.settings.payment_method') ? 'active' : '' }}"
            href="{{ route('admin.settings.payment_method') }}">
            <span class="menu-icon">
                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                <span class="svg-icon svg-icon-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
    ...
    <div class="menu-item">
        <a class="menu-link {{ request()->routeIs('admin.settings.point_system') ? 'active' : '' }}"
            href="{{ route('admin.settings.point_system') }}">
            <span class="menu-icon">
                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                <span class="svg-icon svg-icon-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
    ...
    <div class="menu-item">
        <a class="menu-link {{ request()->routeIs('admin.settings.general_settings') ? 'active' : '' }}"
            href="{{ route('admin.settings.general_settings') }}">
            <span class="menu-icon">
                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                <span class="svg-icon svg-icon-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
